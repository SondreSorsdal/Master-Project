...
#If rename treatments
# %>%   mutate(treatment=dplyr::recode(treatment, '1' = "GT", '2' = "GT+FS14", '4' = "GT+Insect", '5' = "GT+FS14+Insect", '6' = "GT+FS1", '7' = "GT+FS1+Insect" ))
...
#exaple on how time series plot is made in R
#timeseries_test <- read_excel("for_minitab1.xlsx")

#ggplot(timeseries_test) +
#  aes(
#    x = date,
#    y = Mean,
#    colour = treatment,
...
#datasheet for minitab_1 <- data.frame(Aphid_shoots_plum %>%
...
#Below is the script for manipulating the data for use in Minitab for creating the time series graph.
#minitab_2 <- data.frame(Aphid_population_plum %>%
#                                 group_by(treatment, date) %>%
 #                                 summarise(Mean = mean(aphid_population)))

#write.xlsx(minitab_2, "for_minitab2")
...
#minitab_3 <- data.frame(Aphid_shoots_plum %>%
#                                 group_by(treatment, date) %>%
#                                 summarise(Mean = mean(aphid_shoots)))

#write.xlsx(minitab_3, "for_minitab3")
